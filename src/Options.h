...
public:
    ...
    inline bool doublehxsh() const                { return m_doublehxsh; }
    ...
    inline const std::vector<Url*> &nodemasters() const { return m_nodemasters; }
    inline int algo() const                       { return m_algo; }
    inline int algoVariant() const                { return m_algoVariant; }
    inline int apiPort() const                    { return m_apiPort; }
    inline int dnxxLevel() const                { return m_dnxxLevel; }
