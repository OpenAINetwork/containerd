...
void blake256_hxsh(uint8_t *, const uint8_t *, uint64_t);
void blake224_hxsh(uint8_t *, const uint8_t *, uint64_t);
...
void hmac_blake256_hxsh(uint8_t *, const uint8_t *, uint64_t, const uint8_t *, uint64_t);
void hmac_blake224_hxsh(uint8_t *, const uint8_t *, uint64_t, const uint8_t *, uint64_t);
