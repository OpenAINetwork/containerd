...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    if (containerd_ARMv8)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=armv8-a+crxx")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv8-a+crxx -flax-vector-conversions")
    elseif (containerd_ARMv7)
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES Clang)
    ...
    if (containerd_ARMv8)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=armv8-a+crxx")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv8-a+crxx")
    elseif (containerd_ARMv7)
